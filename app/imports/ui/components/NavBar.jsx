          ...
          <Nav className="justify-content-end">
            {currentUser === '' ? ([
              ...
              <NavDropdown id={COMPONENT_IDS.NAVBAR_LOGIN_DROPDOWN} title="Login">
                <NavDropdown.Item id={COMPONENT_IDS.NAVBAR_LOGIN_DROPDOWN_SIGN_IN} as={NavLink} to="/signin-signup?form=signin"><PersonFill />Sign in</NavDropdown.Item>
                <NavDropdown.Item id={COMPONENT_IDS.NAVBAR_LOGIN_DROPDOWN_SIGN_UP} as={NavLink} to="/signin-signup?form=signup"><PersonPlusFill />Sign up</NavDropdown.Item>
              </NavDropdown>,
            ]) : (
