      ...
      <Container>
        ...
        <Navbar.Collapse id={COMPONENT_IDS.NAVBAR_COLLAPSE}>
          ...
          <Nav className="justify-content-end">
            {currentUser === '' ? ([
              <Nav.Link as={NavLink} to="/contact" key="contact">Contact Us</Nav.Link>,
              <NavDropdown id={COMPONENT_IDS.NAVBAR_LOGIN_DROPDOWN} title="Login"><NavDropdown.Item id={COMPONENT_IDS.NAVBAR_LOGIN_DROPDOWN_SIGN_IN} as={NavLink} to="/signin"><PersonFill />Sign in</NavDropdown.Item>
              ...
              <NavDropdown id={COMPONENT_IDS.NAVBAR_CURRENT_USER} title={currentUser}>
                <NavDropdown.Item id={COMPONENT_IDS.NAVBAR_SIGN_OUT} as={NavLink} to="/userpage"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User Page</NavDropdown.Item>
